    ...
    <div className="min-h-screen w-full flex items-center justify-center p-4">
      ...
      <Card className="w-full max-w-md border-zinc-700 shadow-xl shadow-black/20 backdrop-blur-sm bg-zinc-800/80">
        ...
        <CardContent className="space-y-6">
          <Button 
            variant="outline" 
            className="w-full h-11 border-zinc-700 hover:bg-zinc-700 hover:text-[#dbdbdb] transition-all gap-3 font-medium rounded-xl bg-zinc-800 text-[#dbdbdb]"
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-zinc-800 px-3 text-[#dbdbdb]/60 font-medium">Or continue with</span>
            </div>
          </div>
        ...
        <CardFooter className="flex justify-center border-t border-zinc-700 mt-4 py-6">
          <p className="text-xs text-[#dbdbdb]/60 text-center px-4">
